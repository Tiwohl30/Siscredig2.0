        ...
        return (
            <div>
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                    <span className="navbar-brand" >Administrador</span>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <span className="nav-link" >Vista previa credencial</span>
                            </li>
                            <li className="nav-item">
                                <span className="nav-link" >Gestión de usuarios</span>
                            </li>
                            <li className="nav-item">
                                <span className="nav-link" >Gestión de credenciales</span>
                            </li>
                            <li className="nav-item active">
                                <span className="nav-link" >Mensajería</span>
                            </li>
                        </ul>
                    </div>
                </nav>
